...
/* Spare fonts */
static char *font2[] = { "Droid Sans Mono:style=Regular:pixelsize=14:antialias=true:autohint=true", };
...
MouseKey mkeys[] = {
	...
	{ Button4,              MODKEY,    			zoom,	      		{.f = +1} }, // Zoom+: MODKEY + scroll up.
	{ Button5,              MODKEY, 			  zoom, 	     		{.f = -1} }, // Zoom-: MODKEY + scroll down.
	{ Button2,              MODKEY, 			  clipcopy, 	    {.i =  0} },
	{ Button2,              MODKEY, 			  clippaste, 	    {.i =  0} },
};
